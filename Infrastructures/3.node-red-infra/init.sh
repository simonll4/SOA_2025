...
wait_for_container_healthy "nginx1" || exit 1

docker compose up -d certbot1
wait_for_container_healthy "certbot1" || exit 1

docker compose up -d cert-exporter1
wait_for_container_healthy "cert-exporter1" || exit 1
