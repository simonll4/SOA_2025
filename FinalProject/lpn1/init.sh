...
CERT_PATH="./certs/lpn1.crabdance.com/fullchain.pem"
BACKUP_FILE="./certs/lpn1.crabdance.com/fullchain.pem.backup"
...
docker compose up -d influxdb2 keycloack-postgres
