...
import { useFaceVerification } from '@/composables/services/useServiceFaceVerification'
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg p-6 max-w-md w-full mx-4">
      ...
      <div class="text-center">
        <p class="text-gray-600 dark:text-gray-300 mb-4">
          Para ejecutar comandos críticos, necesitas verificar tu identidad mediante reconocimiento
          facial.
        </p>
        ...
        <div v-if="loading" class="mt-4 text-blue-600 dark:text-blue-400">Procesando imagen...</div>
        ...
        <div
          v-if="result && result.status === 'success'"
          class="mt-4 p-3 bg-green-100 dark:bg-green-900 rounded-lg"
        >
          <p class="text-green-800 dark:text-green-200 font-medium">✓ Verificación exitosa</p>
