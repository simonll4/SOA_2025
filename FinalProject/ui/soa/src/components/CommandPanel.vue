      ...
      <div class="space-y-6">
        ...
        <div class="flex flex-col items-center space-y-3">
          ...
          >
            ...
            <div v-if="ledState" class="absolute inset-0 rounded-full bg-yellow-300 opacity-30 animate-pulse"></div>
          ...
          <span 
            ...
            :class="ledState ? 'text-yellow-600 dark:text-yellow-400 font-bold' : 'text-gray-500 dark:text-gray-400'"
          >
        ...
        <div class="flex flex-col items-center space-y-4">
          ...
          <div class="relative">
            ...
            <svg width="200" height="120" viewBox="0 0 200 120" class="overflow-visible">
              ...
              <!-- Angle indicators -->
              <text x="20" y="115" text-anchor="middle" class="fill-gray-500 text-xs font-medium">0°</text>
              <text x="100" y="25" text-anchor="middle" class="fill-gray-500 text-xs font-medium">90°</text>
              <text x="180" y="115" text-anchor="middle" class="fill-gray-500 text-xs font-medium">180°</text>
            </svg>
            
            <!-- Servo angle input -->
            <div class="absolute inset-0 flex items-center justify-center">
              <div class="text-center">
                <div class="text-2xl font-bold text-gray-900 dark:text-white">{{ servoAngle }}°</div>
        ...
        <div class="flex flex-col items-center space-y-4">
          ...
          <div class="relative">
            ...
            >
              <div class="absolute inset-0 rounded-full bg-gradient-to-br from-transparent via-transparent to-black opacity-10"></div>
            </div>
            <!-- Hidden color input -->
            <input
              ref="colorPicker"
...
const emit = defineEmits<{
  (e: 'critical-command', command: any): void
}>()

const { executeCommand: execCmd, executeCriticalCommand, isExecuting, commandHistory, faceVerificationToken } = useCommands()
...
const criticalCommands = ref([
  { id: 'pump-start-f', label: 'Iniciar Bomba F', description: 'Activar bomba de fluido F', topic: '/startf' },
  { id: 'pump-stop-f', label: 'Detener Bomba F', description: 'Desactivar bomba de fluido F', topic: '/stopf' },
  { id: 'pump-start-d', label: 'Iniciar Bomba D', description: 'Activar bomba de fluido D', topic: '/startd' },
  { id: 'pump-stop-d', label: 'Detener Bomba D', description: 'Desactivar bomba de fluido D', topic: '/stopd' },
])
