...
CERT_PATH="./certs/lpn2.crabdance.com/fullchain.pem"
BACKUP_FILE="./certs/lpn2.crabdance.com/fullchain.pem.backup"
...
docker compose up -d nodered mqtt_proxy_service mosquitto-SOA
