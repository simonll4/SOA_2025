...
CERT_FILE="/home/user/SOA2025/influx/certbot/conf/live/lpn1.crabdance.com/fullchain.pem"
BACKUP_FILE="/home/user/SOA2025/influx/certbot/conf/live/lpn1.crabdance.com/fullchain.pem.backup"
...
# Iniciar servicios
echo "${GREEN}Iniciando servicio influxdb...${NC}"
...
CERT_PATH="/home/user/SOA2025/influx/certbot/conf/live/lpn1.crabdance.com/fullchain.pem"
if [ -f "$CERT_PATH" ]; then
