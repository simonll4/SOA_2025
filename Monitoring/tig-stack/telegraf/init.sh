...
CERT_FILE="/home/user/SOA2025/telegraf/certbot/conf/live/lpn2.crabdance.com/fullchain.pem"
BACKUP_FILE="/home/user/SOA2025/telegraf/certbot/conf/live/lpn2.crabdance.com/fullchain.pem.backup"
...
CERT_PATH="/home/user/SOA2025/telegraf/certbot/conf/live/lpn2.crabdance.com/fullchain.pem"
if [ -f "$CERT_PATH" ]; then
...
# # Declarar CONTAINER_NAME como una variable local
# CONTAINER_NAME="certbot"
# # Esperar a que el contenedor de Certbot esté listo
# while true; do
#     STATUS=$(docker inspect --format='{{.State.Health.Status}}' "$CONTAINER_NAME" 2>/dev/null)
